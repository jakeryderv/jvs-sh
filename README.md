...
The background uses `public/media/iss-background.mp4`, a full-resolution 1080p60 H.264 web copy of
...
Reduced motion shows the 1080p `public/media/iss-poster.jpg` without downloading the video;
